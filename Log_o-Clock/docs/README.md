...
This folder is the starting point for a new development context. The documents describe the application as implemented in source at version **1.144.2** and SQLite schema **28**.
