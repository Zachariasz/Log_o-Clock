...
public sealed partial class SqliteTrackerStore
{
    ...
    [
        ...
        new("AutomaticTagConcepts", "AutomaticTagConcepts", ["TagId"], ["TagId", "BuiltInKey", "MatchText", "ModifiedUtc"], 40),
        new("TaskAutomaticTagPreferences", "TaskAutomaticTagPreferences", ["TaskId"], ["TaskId", "TagId", "IsSuppressed", "ModifiedUtc"], 50),
        new("AutomaticTagConceptSuppressions", "AutomaticTagConceptSuppressions", ["BuiltInKey"], ["BuiltInKey", "ModifiedUtc"], 40),
